...
int main() {
    ...
    system("clear");
    if (choix==0) {
        ouvrirFichier("../pokemon/choix_joueur_vs_ordinateur_moyen_1vs1"); 
    } else if (choix == 1) {
        ouvrirFichier("../pokemon/choix_joueur_vs_ordinateur_moyen_2vs2");
    } else if (choix == 2) {
        ouvrirFichier("../pokemon/choix_joueur_vs_ordinateur_moyen_3vs3");
